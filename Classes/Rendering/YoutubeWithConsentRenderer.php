...
{
    public const DEFAULT_TEMPLATE = 'EXT:gdpr/Resources/Private/Templates/Rendering/Youtube.html';
    ...
    public function render(FileInterface $file, $width, $height, ?array $options = null)
    {
        ...
        $templatePath = $options['gdpr-youtube-template'] ?? self::DEFAULT_TEMPLATE;
